...
import { fetchData, deleteInvoice } from 'src/store/invoice'
...
import TableHeader from 'src/views/invoice/list/TableHeader'
    ...
    ...defaultColumns,
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Tooltip title='View'>
            <IconButton size='small' component={Link} sx={{ mr: 0.5 }} href={`/invoice/preview/${row.id}`}>
