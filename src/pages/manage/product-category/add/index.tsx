...
const ProductCategoryAdd = (props: Props) => {
  ...
  const {
    ...
    defaultValues: { name: '', displayOrder: 1, isDefault: true },
    mode: 'onChange',
    resolver: yupResolver(schema)
  })

  const submitForm = async (data: ProductCategoryType) => {
    axiosInterceptorInstance.post(`/api/ProductCategory/Create`, data).then(() => {
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader title='Create Product Category' />
        <CardContent>
